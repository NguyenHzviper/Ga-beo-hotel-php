...
<div class="container-fluid">
	<div class="col-lg-12">
		...
		<div class="row">
			<button class="btn btn-primary btn-sm" id="new_folder"><i class="fa fa-plus"></i> Tạo thư mục</button>
			<button class="btn btn-primary btn-sm ml-4" id="new_file"><i class="fa fa-upload"></i> Tải Files</button>
		</div>
		<hr>
		<div class="row">
			<div class="col-lg-12">
		...
		<div class="row">
			<div class="card col-md-12">
				<div class="card-body">
					<table width="100%">
						<tr>
							<th width="40%" class="">Tên file</th>
							<th width="20%" class="">Ngày</th>
...
<div id="menu-folder-clone" style="display: none;">
	...
	<a href="javascript:void(0)" class="custom-menu-list file-option delete">Xóa</a>
</div>
<div id="menu-file-clone" style="display: none;">
	<a href="javascript:void(0)" class="custom-menu-list file-option edit"><span><i class="fa fa-edit"></i> </span>Đổi tên</a>
	<a href="javascript:void(0)" class="custom-menu-list file-option download"><span><i class="fa fa-download"></i> </span>Tải xuống</a>
	<a href="javascript:void(0)" class="custom-menu-list file-option delete"><span><i class="fa fa-trash"></i> </span>Xóa</a>
</div>
