									...
									<div class="row">
										<div class=" col-md-4">
											...
											<select class="custom-select browser-default" name="category_id">
												<option value="all" <?php echo isset($_GET['category_id']) && $_GET['category_id'] == 'all' ? 'selected' : '' ?>>Tất cả</option>
												<?php 
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
											<button class="btn btn-sm btn-primary check_in" type="button" data-id="<?php echo $row['id'] ?>">Đặt phòng</button>
									</td>
								</tr>
							<?php endwhile; ?>
							</tbody>
