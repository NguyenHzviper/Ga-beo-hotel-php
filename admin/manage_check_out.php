...
<div class="container-fluid">
	<p><b>Phòng: </b><?php echo isset($room['room']) ? $room['room'] : 'NA' ?></p>
	<p><b>Loại phòng: </b><?php echo $cat['name'] ?></p>
	<p><b>Giá phòng: </b><?php echo '$'.number_format($cat['price'],2) ?></p>
	<p><b>Số tham chiếu: </b><?php echo $ref_no ?></p>
	<p><b>Nhận phòng: </b><?php echo $name ?></p>
	...
	<p><b>Ngày: </b><?php echo $calc_days ?></p>
	<p><b>Tổng(giá phòng * số ngày ở) : </b><?php echo '$'.number_format($cat['price'] * $calc_days ,2) ?></p>
		...
		<div class="row">
			<?php if(isset($_GET['checkout']) && $status != 2): ?>
				...
				<div class="col-md-3">
					<button type="button" class="btn btn-primary" id="edit_checkin">Sửa</button>
				</div>
		<?php endif; ?>	
				<div class="col-md-3">
