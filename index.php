            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=about">Về chúng tôi</a></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <div class="modal-dialog modal-md" role="document">
      ...
      <div class="modal-footer">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Gà Béo Luxury <br> Email: gabeodangbay@gmail.com <br> Liên hệ: 09999888877 <br> Địa chỉ: Thành phố Hồ Chí Minh </div></div>
